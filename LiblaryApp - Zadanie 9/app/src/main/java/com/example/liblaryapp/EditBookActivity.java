...
public class EditBookActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_EDIT_BOOK_TITLE = "com.example.liblaryapp.EDIT_BOOK_TITLE";
    public static final String EXTRA_EDIT_BOOK_AUTHOR = "com.example.liblaryapp.EDIT_BOOK_AUTHOR";
    public static final String EXTRA_EDIT_BOOK_ID = "com.example.liblaryapp.EDIT_BOOK_ID";
